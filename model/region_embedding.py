...
# Implement model of "A NEW METHOD OF REGION EMBEDDING FOR TEXT CLASSIFICATION"
# which can be seen at https://openreview.net/pdf?id=BkSDMA36Z
#
# insert padding is IMPORTANT, padding length is set to be the
# radius of the region(half of region size).
...
class RegionEmbeddingEstimator(tf.estimator.Estimator):
    VALID_MODE = ["WC", "CW"]
